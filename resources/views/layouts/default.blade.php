        ...
        <div class="wrapper">
                            ...
                            @if (Auth::check())
                                <li class="dropdown user user-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span class="hidden-xs" style="font-weight: 700;font-size: 14px;line-height: 22px;padding: 14px;">
            ...
            <div class="content-wrapper" role="main" id="setting-list">
                ...
                <section class="content-header" style="padding-bottom: 30px;">
                    <h1 style="font-family: 'Raleway', sans-serif; font-weight: bold;"  class="pull-left pagetitle">@yield('title') </h1>
